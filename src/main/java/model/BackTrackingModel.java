...
/**
 * This class contains methods used to find all possible solutions for the N-Queens problem, using a type of
...
public class BackTrackingModel {
     ...
     */
    public void backtrackingApproach(Integer chosenNumOfQueens) {
